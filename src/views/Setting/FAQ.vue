<template>
  <div class="setting-page">
    ...
    <van-collapse v-model="activeNames">
      <van-collapse-item :title="$t('KwSsYWyF0HXlP8lggxLqt')" name="1">{{ $t('6iJYYx2KV_KWyAz0yS1CS') }}</van-collapse-item>
      <van-collapse-item :title="$t('8msFTe9uT5LS1hBRYrhDQ')" name="2"><a href="https://www.nanoka.top/posts/e78ef86/" target="_blank">https://www.nanoka.top/posts/e78ef86/</a></van-collapse-item>
      <van-collapse-item :title="$t('kK53pSxdX9IOIwBqBIClc')" name="3">{{ $t('BKT3O7AHWaF4y-_ZST_NG') }}</van-collapse-item>
      ...
      <van-collapse-item :title="$t('hNq6xDwKzWRVTCurKT2VB')" name="5">{{ $t('FKYu426sygq6j2G9o7cPa') }}</van-collapse-item>
      <van-collapse-item :title="$t('7Qp6wS6ighxbdX6P79aH8')" name="6">{{ $t('94IU-NPgYBjKNVa_XspuT') }}</van-collapse-item>
