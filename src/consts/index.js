...
export const CURRENT_APP_VERSION = 'v1.22.12'
...
export const PIXIV_NEXT_URL_ALTS = process.env.VUE_APP_PIXIV_NEXT_URL_ALTS || ''
export const PIXIV_NEXT_URL_DEF = 'https://api.cocomi.eu.org'
export const PIXIV_NEXT_URL = LocalStorage.get('PIXIV_NEXT_URL', PIXIV_NEXT_URL_DEF)
